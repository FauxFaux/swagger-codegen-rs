...
pub fn go<W: Write>(mut into: W) -> Result<(), Error> {
    ...
    writeln!(into, "// generated by swagger-codegen-rs")?;
    writeln!(into, "use failure::Error;")?;
    writeln!(into, "use reqwest::Client;")?;
    writeln!(into, "use reqwest::header::Headers;")?;
    writeln!(into, "use reqwest::Url;")?;
    writeln!(into)?;
