...
pub fn go<W: Write>(mut into: W) -> Result<(), Error> {
    ...
    writeln!(&mut into, "// generated by swagger-codegen-rs")?;
    writeln!(&mut into, "use failure::Error;")?;
    writeln!(&mut into, "use reqwest::Client;")?;
    writeln!(&mut into, "use reqwest::header::Headers;")?;
    writeln!(&mut into, "use reqwest::Url;")?;
